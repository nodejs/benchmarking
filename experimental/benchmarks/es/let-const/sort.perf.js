...
function runBenchmarks(count) {
    ...
    runner.runBenchmarks('es.2015.let-const.lomutos', function(suite) {
        runner.buildNTests(count, 'es.2015.let.lomutos', suite, lomutos);
    });
    runner.runBenchmarks('es.2015.let-const.hoare', function(suite) {
        runner.buildNTests(count, 'es.2015.let.hoare', suite, hoare);
    });
}
